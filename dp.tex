...
\begin{description}
  \item[diagnosis:] predict patient's depression score range measured \emph{at the time of the recording} based on EEG signal sample obtained \emph{at the time of the recording}, and
  \item[prognosis:] predict the ratio of patient's depression scores measured \emph{during the first and second visits} based on EEG signal sample obtained \emph{during the first visit}, made 4 weeks before the second visit.
\end{description}
...
In further analysis, unless otherwise specified, recordings were shortened to a fixed length of 60 s (15~000 timesteps). This measure was taken in order to achieve the following characteristics on the data:
\begin{enumerate}
...
\noindent\makebox[\textwidth]{%
  ...
  \caption[Trends in $\lambda_1$ as function of depression score.]{Trends of values of the largest Lyapunov exponent as a function of depression score. The correlation is significantly ($p$ < 0.05) positive for all channels with exception of FP1, FP2, C3, F7, F8, T3.}
