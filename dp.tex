...
Data: How we chose the labels, how we split the data. Only before for remission.
...
Conclusions: SHAL has state of the art performance on REM. It would be nice to evaluate against pure FBCSP, and try more traditional configuration to see difference in performance. 
