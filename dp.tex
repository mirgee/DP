...
\begin{figure}
  ...
  \caption[Topographic correlation map.]{Topographic map of correlation coefficients on a scalp for depression diagnosis and remission prognosis respectively. Color at each channel marks the value of Pearson's correlation coefficient between the value of corresponding measure and label across all patients.}
  \label{fig:scalp-corrs}
\end{figure}
