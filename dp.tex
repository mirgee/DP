...
It is well known that the results of algorithms for estimation of non-linear measures presented in Section \ref{sec:nonlin-meas} depend on the choice not only on the amount of noise in the data, the way of data preprocessing and the choice of the algorithm, but also, to a considerable degree, on the embedding parameters and other input parameters \cite{fell1994resonance}. Therefore, their choice is of substantial importance.
