...
\add[inline]{Describe the type of GPA algo used.}
...
Fig. \ref{fig:loc-d2} shows the log plot of local slope of of $\log C(r)$ as a function of $r$. There are no apparent scaling regions at all. 
...
\noindent\makebox[\textwidth]{%
  ...
  \caption{Local $D_2$ as a function of radius $r$ for dimensions in range from $5$ to $30$ (from left to right) and time delays $\tau = 4$ and $\tau = 8$.}
  \label{fig:loc-d2}
\end{figure}
