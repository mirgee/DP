...
(NOTES: For highly chaotic systems, autocorrelation decays fast \cite{kantz2004}. Lower bound for $\tau$ is $1 - \frac{\sigma_{\text{noise}}}{\sigma_{\text{signal}}}$.)
