...
Briefly what CSP serves for.

Why is spatial filtering important: noise from imprecise recording, ``noise'' because signals conveyed (motor activities modulate $\mu$-rhythm) in different frequency bands, spatial origin of the signal may be important (diff. parts of somatosensory cortex are responsible for diff. movements), but we have low spatial resolution due to limited number of electrodes.

\subsection{CSP analysis}
CSP analysis in more detail

\subsection{Filter Bank Common Spatial Patterns (FBCSP)}
Why it sometimes fails, what FBCSP is.

It was originally proposed for people with impeded motor control (e.g. disabled people) in context of BCI. But we show that similar method can be used to diagnose DEP and REMIS.
...
DEP & $0-f_{\text{fin}}$ & SHAL &                           \\ \hline 
 & $4-f_{\text{fin}}$ & SHAL &     $84.16 \pm 1.05 \%$     \\ \hline 
 & $0-f_{\text{fin}}$ & DEEP &                            \\ \hline 
 & $4-f_{\text{fin}}$ & DEEP &                            \\ \hline 
