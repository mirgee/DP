...
As mentioned in Chapter 1, brain is a non-linear dynamical system. Another possibility, therefore, is to represent the input data as recurrence plots, mentioned in Section . The obvious drawbacks redundancy due to symmetry and high dimensionality. On the other hand, recurrence plots are known to capture properties of the system which are difficult to obtain using other methods in some cases. \add{Cite this.}
...
\add[inline]{We might want to show the missclasifications - how close were they? Are people acting, or is the measurement relatively objective?}
\end{table}
