...
TODO: Sleep disorder diagnosis is also relevant for us for the close connection of depression with disturbed sleep and insomnia \cite{}.
...
\begin{algorithm}
  % \caption{Counterfactual Regret Minimization with chance sampling. \cite{cfr_intro}}
  \label{alg:gd}
\begin{algorithmic}[1]
  \State Initialize random $x_0 \in D(f)$
  \State $n \gets 0$
  \While{$|\nabla_{x_n} f| < \text{threshold}$}
