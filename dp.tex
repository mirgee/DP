...
Although the science of EEG signal analysis as a diagnostic tool brings compelling clinical promise as a result of the aforementioned benefits, it also presents multiple conceptual challenges. 

%TODO: Read Kaplan and expand this section
Most importantly, EEG signals are known to have characteristics that are transient, nonstationary and nonlinear \cite{kaplan2005}. Moreover, different patterns appear at multiple scales, from slow cortical potentials at less than 1 Hz, to $\alpha$-potentials at 8-16 Hz, and since many of these patterns do not repeat relative to a stimulus, a successful classifier must be able to detect a pattern regardless of its starting time.
