...
% In Table \ref{tab:lleba}, we can see, for example, that the mean values of $\lambda_1$ across channels are significantly diffent between recordings for the responding group, but not for the nonresponders.
