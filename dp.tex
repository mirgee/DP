...
% In this section, we compare the differences between various subgroups in the dataset with measure values obtained using the methods described in the previous section. The hyperparameters we used in this section, summarized in Table , are the same as used in the classification tasks.
