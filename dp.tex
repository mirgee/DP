...
\begin{align*}
  G = \begin{pmatrix}
      \cos(\phi_1 \oplus \phi_1)  & \cos(\phi_1 \oplus \phi_2) & \dots & \cos(\phi_1 \oplus \phi_N) \\
      \cos(\phi_2 \oplus \phi_1)  & \cos(\phi_2 \oplus \phi_2) &  \dots & \cos(\phi_2 \oplus \phi_N)  \\
      \vdots & \vdots & \dots & \vdots \\
      \cos(\phi_N \oplus \phi_1)  & \cos(\phi_N \oplus \phi_2)  & \dots & \cos(\phi_N \oplus \phi_N)
     \end{pmatrix}.
\end{align*}
