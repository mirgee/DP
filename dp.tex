...
Very briefly (everyone knows): fully connected, gradient based learning (backpropagation), convolution, equivariance, invariance.

\begin{dfn}[Discrete convolution]
...
TODO: In machine learning libraries, however \dots

\begin{dfn}[Equivariance]
  
\end{dfn}

TODO: In other words, \dots 
