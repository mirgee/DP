...
\noindent\makebox[\textwidth]{%
  ...
  \caption[Typical behavior of local $D_2$.]{Plot of a typical local correlation dimension estimates for embedding dimensions from $m=2$ to $m=22$ (from bottom to top) in favorable case \cite{andreas2000}. Note mainly the scaling region where the slope estimates converge to the value of $2$. To compare with our results, see Figure \ref{fig:loc-d2}.}
...
\noindent\makebox[\textwidth]{%
  ...
  \caption[Normalized $C(r)$ for various $m$.]{Normalized correlation sum as a function of radius $r$ for embedding dimension dimensions in range from $5$ to $30$ (from left to right).}
  \label{fig:cr}
\end{figure}
...
\noindent\makebox[\textwidth]{%
  ...
  \caption[Local $D_2(r)$ for various $m$.]{Local correlation dimension $D_2$ as a function of radius $r$ for dimensions in range from $5$ to $30$ (from bottom to top) and time delays $\tau = 4$ and $\tau = 8$.}
  \label{fig:loc-d2}
\end{figure}
...
\noindent\makebox[\textwidth]{%
  ...
  \caption[Local $D_2(r)$ for various $m$ in comparison with a surrogate.]{Local correlation dimension $D_2$ as a function of radius $r$ for dimensions in range from $5$ to $30$ (from bottom to top) and time delays $\tau = 4$ and $\tau = 8$ for the original series (blue) and its surrogate series computed using iAAFT.}
