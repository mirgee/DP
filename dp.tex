...
Emotion recognition using LLE from EEG signals was performed in \cite{aftanas1997non} with embedding dimension $m=10$ and time delay $\tau=3$. No reasoning behind this choice was provided. The remaining studies we examined either used various thresholds of autocorrelation function (see Section \ref{sec:acorr}) or delayed mutual information (see Section \ref{sec:dmi}) for time delay selection.
...
Remaining studies we evaluated, including some analyzing depression, used embedding dimension 10 \cite{roschke1995nonlinear, fell1993deterministic, roschke1993calculation, roschke1995nonlineardeppression}.
