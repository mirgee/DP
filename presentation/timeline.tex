...
\draw[Line, shorten >=17pt] ([ys=-11mm]  c) node[below] {EEG recorded\\DS measured\\Prognosis\\Change treatment?} -- (c);
% \draw[Line] ([ys=7mm]  f) -- (f);
\draw[Line, shorten >=17pt] ([ys=-11mm] a) node[below] {EEG recorded\\DS measured\\Diagnosis\\Drugs administred} -- (a);\draw[Line, shorten >=17pt] ([ys=-11mm]  e) node[below]{DS measured\\Evaluation} -- (e);
...
% \draw[Line] ([ys=7mm]  f) -- (f);
\draw[Line, shorten >=17pt] ([ys=-11mm] a) node[below] {EEG recorded\\DS measured\\Diagnosis\\Drugs administred\\\textcolor{red}{Prognosis}} -- (a);
